...
{  
  viennamesh::register_data_type<viennamesh::pragmatic::pragmatic_mesh>(context);

  viennamesh::register_conversion<viennagrid_mesh, viennamesh::pragmatic::pragmatic_mesh>(context); //Viennagrid data structure --> Pragmatic data structure
