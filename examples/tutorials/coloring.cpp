...
int main(int argc, char **argv)
{
	...
	viennamesh::algorithm_handle coloring = context.make_algorithm("parallel_coloring");
	coloring.set_default_source(mesh_reader); 
    coloring.run();
    ...
    mesh_writer.set_default_source(coloring);
    mesh_writer.set_input("quantities", coloring.get_output("color_field"));
    mesh_writer.set_input("filename", "coloring.vtu");
    mesh_writer.run();
	//*/
